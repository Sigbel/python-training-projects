...
zero deve ser informado pelo operador para indicar o final da compra. O programa deve então mostrar 
o total da compra e perguntar o valor em dinheiro que o cliente forneceu, para então calcular e 
mostrar o valor do troco. Após esta operação, o programa deverá voltar ao ponto inicial, para 
...
while finaliza != True:
    produto = float(input(f"Produto {c+1}: R$ "))
    if produto == 0:
        finaliza = True
    soma = soma + produto
    c += 1
