...
A. Cada funcionário receberá o equivalente a 20% do seu salário bruto de dezembro; O piso do abono será de 100 
reais, isto é, aqueles funcionários cujo salário for muito baixo, recebem este valor mínimo; Neste momento, não se 
deve ter nenhuma preocupação com colaboradores com tempo menor de casa, descontos, impostos ou outras 
...
print()
print('Salário'.ljust(13), ' - ', 'Abono'.ljust(13))
for c1 in range(len(salarios)):
    print('R$', f'{salarios[c1]:.2f}'.rjust(10), ' - ', 'R$', f'{abonos[c1]:.2f}'.rjust(10))

print()
print(f'Foram processados {c} colaboradores')
print(f'Total gasto com abonos: R$ {sum(abonos):.2f}')
print(f'Valor mínimo pago para {c_min} colaboradores')
